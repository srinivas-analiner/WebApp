    ...
    public class MiddleTyre_Mysql
    {
        ...
        public static void connection(ref MySqlConnection con)
        {
            try
            {
                ...
                //constr_Mysql = "Data Source=192.168.8.167;port=3306;Initial Catalog=saazdbms;User Id=saazadmin;password=Akshar!23;Allow User Variables=True;Convert Zero Datetime=True;default command timeout=0;Connection Timeout=120";

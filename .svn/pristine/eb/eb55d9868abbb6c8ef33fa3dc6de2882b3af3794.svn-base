...
Clm_Img_Set_NM varchar(30) unique -- Imaging Settings Name
);
// DELIMITER ;

-- ALTER TABLE Tbl_Img_Set_Mstr MODIFY Clm_Img_Set_NM VARCHAR(30) ;
...
Delimiter //
-- Current Imaging Factory Settings Table
CREATE TABLE IF NOT EXISTS Tbl_Curr_Img_Set_FTY_Dtls
(
Clm_Curr_Img_Set_FTY_Id INTEGER AUTO_INCREMENT  PRIMARY KEY, -- Default Id
Clm_Img_Set_Id int,
Clm_Curr_Val varchar(20), -- Current Value
Clm_Dev_Id int, -- Device Id
FOREIGN KEY (Clm_Img_Set_Id) REFERENCES Tbl_Img_Set_Mstr(Clm_Img_Set_Id),
...
Delimiter //
-- Controller Default Values Table
CREATE TABLE IF NOT EXISTS Tbl_Ctrl_Val_Dtls
(
Clm_Id int AUTO_INCREMENT  PRIMARY KEY, -- Id
Clm_Nm varchar(50) unique, -- Name/Type
Clm_Val varchar(50), -- Value
Clm_Up_D varchar(25) -- DateTime
);
// DELIMITER ;


Delimiter //
-- Tracker Telemetry details
CREATE TABLE IF NOT EXISTS Tbl_Trk_Tlm_Dtls
(
Clm_Id bigint AUTO_INCREMENT  PRIMARY KEY, -- Id
Clm_DT datetime, -- DateTime
Clm_AZM_Err double,
Clm_AZM_Spd double,
Clm_EL_Err double,
Clm_EL_Spd double,
Clm_Row int,
Clm_Col int,
Clm_Sc_Row double, -- Scene Row
Clm_Sc_Col double -- Scene Column
);
// DELIMITER ;


Delimiter //
-- Tracker PTZ Control details
CREATE TABLE IF NOT EXISTS Tbl_Trk_PTZ_Dtls
(
Clm_Id int AUTO_INCREMENT PRIMARY KEY, -- Id
Clm_DT datetime, -- DateTime
Clm_Z_Lvl int, -- Zoom Level
Clm_FL double, -- Focal Length
Clm_AZM_Max double, -- Azimuth Max, Maximum rotation angel for given focal length
Clm_EL_Max double, -- Elevation Max, Maximum rotation angel for given focal length
Clm_V_AZM_Max double, -- Azimuth max Rotation speed
Clm_V_EL_Max double, -- Elevation max Rotation speed
Clm_Dev_Id int, 
Clm_KP double default 0.5, -- Propctional constant
Clm_KI double default 0.01, -- Integral constant
Clm_KP_Tilt double default 0.5, -- Propctional constant
Clm_KI_Tilt double default 0.01, -- Integral constant
FOREIGN KEY (Clm_Dev_Id) REFERENCES Tbl_Dev_Mstr(Clm_Dev_Id),
UNIQUE KEY (Clm_Z_Lvl, Clm_Dev_Id)
);
// DELIMITER ;

-- ALTER TABLE Tbl_Trk_PTZ_Dtls
-- ADD Clm_KI_Tilt double default 0.01;


Delimiter //
-- PTZ Preset Details Table
CREATE TABLE IF NOT EXISTS Tbl_PTZ_Preset_Dtls
(
Clm_Preset_Dtls_Id INTEGER AUTO_INCREMENT  PRIMARY KEY, -- Device Id
Clm_Preset_NM varchar(50) DEFAULT NULL, -- Device Name 
Clm_Preset_CS bool default false -- Current state, 0/De-Active,1/Active
);
// DELIMITER ;

Delimiter //
-- Recording DateTime Table
CREATE TABLE IF NOT EXISTS Tbl_Rec_DT_Dtls
(
Clm_Rec_DT_Id int AUTO_INCREMENT  PRIMARY KEY, -- Recording Status Id
Clm_Rec_DT bool default false, -- Include DateTime on Recording, 0-No , 1-Yes
Clm_Dev_Id int,
FOREIGN KEY (Clm_Dev_Id) REFERENCES Tbl_Dev_Mstr(Clm_Dev_Id)
);
// DELIMITER ;

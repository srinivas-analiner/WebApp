-- DROP VIEWS
DROP VIEW IF Exists GetRecordingDateTimeDetails;
DROP VIEW IF Exists GetPTZPresetDetails;
DROP VIEW IF Exists GetTrackerPTZDetails;
DROP VIEW IF Exists GetTrackerTelemetryDetails;
DROP VIEW IF Exists Pro_UpdateTrackerTelemetryDetails;
DROP VIEW IF Exists GetControllerDefaultValues;
DROP VIEW IF Exists GetImgPolarityTypeDetails;
DROP VIEW IF Exists GetCamFirmwareUpdateDetails;
DROP VIEW IF EXISTS GetBuiltInTestResult;
DROP VIEW IF EXISTS GetBuiltInTestSubTypes;
DROP VIEW IF EXISTS GetBuiltInTestTypes;
DROP VIEW IF EXISTS GetSmartCamStatusDetails;
DROP VIEW IF EXISTS GetSmartCamUpdateDetails;
...
DROP EVENT IF EXISTS Evnt_Del_Backup;
commit;

-- DROP PROCEDURES
DROP PROCEDURE IF Exists Pro_UpdateRecordingDateTimeDetails;
DROP PROCEDURE IF Exists Pro_RemoveAllPTZPresetDetails;
DROP PROCEDURE IF Exists Pro_RemovePTZPresetDetails;
DROP PROCEDURE IF Exists Pro_UpdatePTZPresetDetails;
DROP PROCEDURE IF Exists Pro_UpdateTrackerPTZDetails;
DROP PROCEDURE IF Exists Pro_UpdateControllerDefaultValues;
DROP PROCEDURE IF Exists Pro_UpdateCamFirmwareUpDetails;
DROP PROCEDURE IF EXISTS Pro_UpdateBuiltInTestResult;
DROP PROCEDURE IF EXISTS Pro_UpdateSmartCamStatusDetails;
DROP PROCEDURE IF EXISTS Pro_UpdateSmartCamUpdateTypeDetails;
DROP PROCEDURE IF EXISTS Pro_UpdateSystemImageDetails;
...
-- DROP TABLES
DROP TABLE IF EXISTS Tbl_Rec_DT_Dtls;
DROP TABLE IF EXISTS Tbl_PTZ_Preset_Dtls;
DROP TABLE IF EXISTS Tbl_Trk_PTZ_Dtls;
DROP TABLE IF EXISTS  Tbl_Trk_Tlm_Dtls;
DROP TABLE IF EXISTS  Tbl_Ctrl_Val_Dtls;
DROP TABLE IF EXISTS  Tbl_Img_Pol_Dtls;
DROP TABLE IF EXISTS Tbl_Cam_Fmw_Up_Dtls;
DROP TABLE IF EXISTS Tbl_BIT_Rslt_Dtls;
DROP TABLE IF EXISTS Tbl_BIT_Typ_Dtls;
DROP TABLE IF EXISTS Tbl_BIT_Typ_Mstr;
DROP TABLE IF EXISTS Tbl_Camera_Variables;
DROP TABLE IF EXISTS Tbl_SmartCam_Stat_Dtls;
DROP TABLE IF EXISTS Tbl_UD_Typ_Mstr;
